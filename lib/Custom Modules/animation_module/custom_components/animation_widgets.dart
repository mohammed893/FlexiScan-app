...
class StickManScreen extends StatefulWidget {
  ...
  StickManScreen({Key? key , this.screenSize = 400}) : super(key: key){
          ...
          return Center(
            child: Stack(
              ...
              children: [
                // Circular background
                Container(
  width: 0.75 * widget.screenSize,
  height: 0.75 * widget.screenSize,
  decoration: BoxDecoration(
    ...
    image: DecorationImage(
      ...
      fit: BoxFit.cover, // Adjusts how the image is fitted inside the circle
                ...
                Positioned(
                  ...
                  child: ValueListenableBuilder<int>(
                    ...
                    builder: (context, level, child) {
                      return SizedBox(
                        width: 0.975 * widget.screenSize, // Adjust the width to fit the artboard
                        height: 0.975 * widget.screenSize, // Adjust the height to fit the artboard
                ...
                SizedBox(
                  width: 0.7325 * widget.screenSize,
                  height: 0.7325 * widget.screenSize,
