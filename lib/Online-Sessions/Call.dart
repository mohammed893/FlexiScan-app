...
import 'package:flexiscan101/Online-Sessions/constants.dart';
...
class _MyWidgetState extends State<CallPage> {
  ...
  Future<void> initialize() async {
    if (appId.isEmpty) {
      setState(() {
        _infoStrings.add('Missing AppId');
        _infoStrings.add('Agora Enigne is not starting');
      });
      return;
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        }, icon: const Icon(Icons.info_outline))],backgroundColor: Colors.black,
      ),
